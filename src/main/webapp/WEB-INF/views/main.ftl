...
<div region="west" style="width: 200px" title="导航菜单" split="true">
    <div class="easyui-accordion" data-options="fit:true,border:false">
        ...
        <#if permissions??>
            <#if permissions?seq_contains("10")>
                ...
                <#if permissions?seq_contains("1020")>
                    <a href="javascript:openTab('客户开发计划','saleChance/cusDev','icon-khkfjh')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-khkfjh'" style="width: 150px">客户开发计划</a>
                </#if>
                </div>
        ...
        <div title="统计报表"  data-options="iconCls:'icon-tjbb'" style="padding:10px">
            ...
            <a href="javascript:openTab('客户构成分析','report/index/1','icon-khgcfx')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-khgcfx'" style="width: 150px;">客户构成分析</a>
            <a href="javascript:openTab('客户服务分析','report/index/2','icon-khfwfx')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-khfwfx'" style="width: 150px;">客户服务分析</a>
...
<div id="dlg" class="easyui-dialog" title="修改密码" style="width:400px;height:250px;padding: 10px 20px"
