...
<div id="p" class="easyui-panel" title="客服服务创建" fit="true">
    <form id="fm" method="post">
        <table cellspacing="15px">
            <tr>
                <td>服务类型：</td>
                <td>
                    <input class="easyui-combobox" id="serveType"
                           name="serveType" panelHeight="auto" editable="false"
                           valueField="dataDicValue" textField="dataDicValue"
                           url="${ctx}/customer/queryDataDicsByDicName?dicName=服务类型"/>
                    &nbsp;<font color="red">*</font>
                </td>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td>客户：</td>
            ...
            <tr>
                ...
                <td colspan="4">
                    <input type="text" id="overview" name="overview"
                           style="width: 419px" class="easyui-validatebox"
 ...
 <textarea id="serviceRequest" name="serviceRequest"
           rows="5" cols="49" class="easyui-validatebox"
